...
void main() {
  ...
  test('submitReport publishes to family group and queues Safety HQ when absent', () async {
  ...
  test('submitReport publishes to both family and Safety HQ when provisioned', () async {
    await database.putSetting(AppConstants.safetyJoinedKey, 'true');
    await database.putSetting(AppConstants.safetyGroupIdSettingKey, 'safety-group');
